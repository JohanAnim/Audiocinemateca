...
class DocumentaryTypeAdapter : TypeAdapter<Documentary>() {
    private val gson = Gson()

    override fun write(out: JsonWriter, value: Documentary?) {
        if (value == null) {
            out.nullValue()
            return
        }
    ...
    override fun read(reader: JsonReader): Documentary? {
